  ...
  Blockly.utils.createSvgElement('path',
      {
        ...
        'd': 'm6.203 7.296 0 1.368-.92.677-.11.41.9 1.559.41.11 1.043-.457 ' +
              '1.187.683.127 1.134.3.3 1.8 0 .3-.299.127-1.138 1.185-.682 1.046' +
              '.458.409-.11.9-1.559-.11-.41-.92-.677 0-1.366.92-.677.11-.41-.9-' +
              '1.559-.409-.109-1.046.458-1.185-.682-.127-1.138-.3-.299-1.8 0-.3' +
              '.3-.126 1.135-1.187.682-1.043-.457-.41.11-.899 1.559.108.409z'
      },
      group);
  // Axle hole.
